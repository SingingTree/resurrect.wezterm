...
describe("utils.ensure_folder_exists", function()
  ...
  -- The probe-write fallback in mkdir_if_missing (triggered when os.rename gives
  -- a false negative due to open handles on Windows) cannot be tested portably
  -- without monkey-patching os.rename. The idempotency test below exercises the
